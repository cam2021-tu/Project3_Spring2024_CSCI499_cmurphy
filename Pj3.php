...
$record_protein = $_POST['protein'];
$sql = "UPDATE $fooditems SET amount = $record_amount, protein = $record_proetin WHERE id = $record_id";
...
<html>
    ...
    <body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <h2>Enter Item Details</h2>
               ...
               <tr>
                   ...
                   <td><input type="text" id="carbohydrate"></td>
        ...
        <tr>
           ...
           <td><button type="button" name="deletebtn" id="deletebtn">Delete</button></td>
        </tr>
           </table>
